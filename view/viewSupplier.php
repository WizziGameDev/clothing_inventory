                        ...
                        <table>
                            ...
                            foreach ($data as $supplier) { ?>
                                <tr>
                                    ...
                                    <td><?= $supplier->getContactId()?></td>
                                    <td><?= $supplier->getAddressId()?></td>
                                    <td>
                                        <div class="button-control">
                                            <a href="#" class="button-edit" data-code="<?=$supplier->getCode()?>" data-name="<?= $supplier->getName()?>" data-email="<?= $supplier->getEmail()?>" data-contact_id="<?= $supplier->getContactId()?>" data-address_id="<?= $supplier->getAddressId()?>">EDIT</a>
                                            <a href="../repository/supplier/deleteSupplier.php?code=<?= $supplier->getCode() ?>" class="button-delete">DELETE</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $counter++;
